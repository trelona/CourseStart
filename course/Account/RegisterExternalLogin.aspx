<%@ Page Language="C#" Title="Регистрация внешней учетной записи" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="course.Account.RegisterExternalLogin" %>
